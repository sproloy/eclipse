...
$url = 'https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/SQLServer2016-x64-ENU.iso'
...
$url1 = 'https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/ConfigurationFile.ini'
...
try
{
    $mountResult = Mount-DiskImage "C:\Program Files\Windows NT\sqlsetup\SQLServer2016-x64-ENU.iso" -PassThru
