...
$url1 = 'https://globalartifactstg.blob.core.windows.net/globalsoftwarelink4artifact/ConfigurationFileDev.ini'
...
try
{
    ...
    Write-Host "Successfully installed SQL Developer 2016";
